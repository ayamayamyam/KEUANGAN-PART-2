...
class DataStoreManager @Inject constructor(private val context: Context) {
    ...
    val activeAccountId: Flow<Long> = context.dataStore.data.map { it[Keys.ACTIVE_ACCOUNT_ID] ?: 1L }
    ...
    suspend fun setActiveAccountId(value: Long) {
        context.dataStore.edit { it[Keys.ACTIVE_ACCOUNT_ID] = value }
    }
}
